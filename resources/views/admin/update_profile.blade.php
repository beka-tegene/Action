...
<div class="container mt-5">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.update',auth()->user()) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-5">
                        <div class="mb-3">
                            ...
                            <select class="form-select form-control @error('usertype') is-invalid @enderror"  autocomplete="usertype" autofocus  name="usertype" aria-label="Default select example">
                                <option value="{{ auth()->user()->usertype }}" >{{ auth()->user()->usertype }}</option>
                ...
                <div>
                    ...
                    <button type="submit" class="col-sm-5 btn btn-success">Submit</button>
