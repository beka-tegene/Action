...
<div class="container mt-5">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('supplier.updateprofile',auth()->user()) }}" method="POST" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <button type="submit" class="col-sm-5 btn btn-success">Uplode</button>
