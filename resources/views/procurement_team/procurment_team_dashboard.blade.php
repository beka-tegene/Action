            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="{{ route('procurmentteam.updatepf') }}">Update Profile</a></li>
                        <li><a class="dropdown-item" href="{{ route('procurmentteam.password') }}">Change Password</a></li>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{ route('procurmentteam.create') }}">{{ __('Post Tender Detail') }}</a>
                                    <a class="nav-link" href="{{ route('categories.create') }}">{{ __('Add Catagory') }}</a>
                                </nav>
                            </div>
                            ...
                            <a class="nav-link" href="">
                                <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
                                {{ __('Approved Supplier') }}
                            </a>

                            <a class="nav-link" href="{{ route('procurmentteam.index') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
                                {{ __('Request') }}
                            </a>
                            ...
                            <a class="nav-link" href="{{ route('procurmentteam.display') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
                                {{ __('Profile') }}
                            </a>
