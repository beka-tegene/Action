            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="{{ route('procurmentapproving.updatepf') }}">update profile</a></li>
                        <li><a class="dropdown-item" href="{{ route('procurmentapproving.password') }}">Change Password</a></li>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="{{ route('procurmentapproving.display') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
                                {{ __('Profile') }}
                            </a>
