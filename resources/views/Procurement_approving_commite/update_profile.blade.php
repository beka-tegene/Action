@extends('Procurement_approving_commite.procurment_approving_dashboard')
@section('content')
<div class="container mt-5">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('procurmentapproving.updateprofile',auth()->user()) }}" method="POST" enctype="multipart/form-data">
